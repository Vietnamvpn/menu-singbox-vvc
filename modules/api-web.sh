...
render_api_menu() {
    while true; do
        ...
        echo -e "${BLUE}================================================================${NC}"
        echo -e " ${GREEN}1.${NC} Thêm / Cập nhật API"
        echo -e " ${GREEN}2.${NC} Bật dịch vụ API Daemon"
        echo -e " ${GREEN}3.${NC} Tắt dịch vụ API Daemon"
        echo -e " ${GREEN}4.${NC} Kiểm tra kết nối tới Web Trung Tâm"
        echo -e " ${GREEN}5.${NC} Gửi thông tin / Link node lên Web"
